...
def repeat_fill_fields(driver):
    ...
    admin_event_form.fill_field_dinamic(field='field-event-resource-11', type=By.ID ,value="20-04-2024")
    admin_event_form.fill_field_dinamic(field='field-event-resource-12', type=By.ID ,value="20-04-2026")
